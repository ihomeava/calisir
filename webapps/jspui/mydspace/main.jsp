...
<%-- add by weicf 2011.12.21 --%>
<%@ taglib uri="http://www.dspace.org/commenting-tags.tld" prefix="commenting" %>
<%-- add by weicf --%>
<%-- add by weicf 2012.01.12 --%>
<%@ taglib uri="http://www.dspace.org/suggest-tags.tld" prefix="suggest" %>
<%-- add by weicf --%>
<%-- add by weicf 2012.01.13 --%>
<%@ taglib uri="http://www.dspace.org/favorite-tags.tld" prefix="favorite" %>
<%-- add by weicf --%>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/mydspace/community-list.js"></script>
...
%>
	...
	<%-- add by weicf 2012.01.13 --%>
	<commenting:unrevisedCommentTag/>
	<commenting:myCommentsTag/>
	<suggest:mySuggestsTag/>
	<favorite:myFavoritesTag/>
	<%-- add by weicf --%>
...
<div style="margin-left: 30px;">
	<form action="<%=request.getContextPath()%>/eperson-community"
		...
		<font color="red">*</font><select name="community_id" id="community_id" onchange="communityList('<%=request.getContextPath() %>',this[selectedIndex].value, '选择机构')">
			...
			name="com_id" value="" /> <input type="submit"
			value="<fmt:message key="jsp.dspace-admin.general.save"/>" />
	</form>
</div>	
	<%--
	<h2><fmt:message key="jsp.mydspace.main.collection.heading" /></h2>
	<p><fmt:message key="jsp.mydspace.main.collection.html" /></p>
	<form action="<%=request.getContextPath()%>/eperson-collection"
		onsubmit="return checkData()" method="post"
		enctype="multipart/form-data">
		<table class="miscTable" align="center"
			summary="Table listing submissions in workflow process">
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.mydspace.main.collection.wizard-basicinfo.community"/></p></td>
				<td><select name="community_id" id="community_id">
						<option selected="selected" value="/">
							<fmt:message key="jsp.general.genericScope" />
						</option>
			...
			<tr>
				<td colspan="2"><input type="hidden" value="true"
					name="public_read" /> <input type="hidden" value="true"
					name="submitters" /> <input type="hidden" value="<%=user.getID()%>"
					name="eperson_id" /> <input type="hidden" value="11"
					name="permission" /></td>
			</tr>
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.name"/></p>
				</td>
				<td><input type="text" id="tname" size="50" name="name" readonly="readonly"
					value="<%=(user.getLastName() + (b ? " " : "") + user
						.getFirstName())%>">
				</td>
			</tr>
			<tr>
				<td class="submitFormHelp" colspan="2"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.shown"/></td>
			</tr>
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.description"/></p></td>
				<td><input type="text" size="50" name="short_description">
				</td>
			</tr>
			<tr>
				<td class="submitFormHelp" colspan="2"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.html1"/></td>
			</tr>
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.intro"/></p></td>
				<td><textarea cols="50" rows="4" name="introductory_text"></textarea>
				</td>
			</tr>
			<tr>
				<td class="submitFormHelp" colspan="2"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.plain"/></td>
			</tr>
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.copyright"/></p></td>
				<td><textarea cols="50" rows="3" name="copyright_text"></textarea>
				</td>
			</tr>
			<tr>
				<td class="submitFormHelp" colspan="2"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.html2"/></td>
			</tr>
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.side"/></p></td>
				<td><textarea cols="50" rows="4" name="side_bar_text"></textarea>
				</td>
			</tr>
			<tr>
				<td class="submitFormHelp" colspan="2"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.license1"/></td>
			</tr>
			<tr>
				<td><p class="submitFormLabel"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.license2"/></p></td>
				<td><textarea cols="50" rows="4" name="license"></textarea></td>
			</tr>
			<tr>
				<td class="submitFormHelp" colspan="2"><fmt:message key="jsp.dspace-admin.wizard-basicinfo.choose"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" value="<fmt:message key="jsp.dspace-admin.general.save"/>" />
				</td>
			</tr>
		</table>
	</form>
